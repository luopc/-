	...
	if($.Datatype){
		...
		$.extend($.Datatype,{
			...
			*/
			...
			//移动电话
			"mobile":/^((\+86)|(86))?13[0-9]{9}$|14[0-9]{9}|15[0-9]{9}$|18[0-9]{9}|17[0-9]{9}$/,
			
			//电话+手机号码
			"phone":/^(^(\d{3,4}-)?\d{7,8})$|(((\+86)|(86))?13[0-9]{9}$|14[0-9]{9}|15[0-9]{9}$|18[0-9]{9}|17[0-9]{9})$/,

			"zm":/^[a-zA-Z][a-zA-Z_]{1,}$/,
			
			//文字及部分特殊字符
			"specStr":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\、\《\》\;\。\(\)\（\）\s]{0,}$/,
