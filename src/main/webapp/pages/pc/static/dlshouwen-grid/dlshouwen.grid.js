...
//					});
				...
				insertConditionTr : function(){
					...
					content += '		</select>';
					content += '	</td>';
					content += '	<td id="valueTd_'+gridReflectionObj.option.id+'_'+gridReflectionObj.sequenceCondition+'"><input type="text" id="value_'+gridReflectionObj.option.id+'_'+gridReflectionObj.sequenceCondition+'" name="value_'+gridReflectionObj.option.id+'_'+gridReflectionObj.sequenceCondition+'" class="form-control" /></td>';
					content += '	<td>';
